...
const CHARSETS = {
  ...
  numeric: "0123456789",
  uk:
    "АБВГҐДЕЄЖЗИІЇЙКЛМНОПРСТУФХЦЧШЩЬЮЯабвгґдеєжзиіїйклмнопрстуфхцчшщьюяABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",
};
    ...
    const animateTo = (targetPhrase) => {
      ...
      const plans = targetChars
        .map((targetChar, index) => {
          ...
          if (fromChar === targetChar && !forceReflip) return null;
          if (targetChar === " " && fromChar === " ") return null;
